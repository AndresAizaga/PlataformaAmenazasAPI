...
{
    public class VulnerabilidadesConfig : IEntityTypeConfiguration<Vulnerabilidades>
    {
        public void Configure(EntityTypeBuilder<Vulnerabilidades> builder)
        {
            builder.ToTable("Vulnerabilidades");
            builder.HasKey(x => x.id);
            builder.Property(x => x.id).HasColumnName("id");
            builder.Property(x => x.vulnerabilidad).HasColumnName("vulnerabilidad");
